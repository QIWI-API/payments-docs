...
3. Дождитесь завершения платежа: вам придет [уведомление](#payment_callback), или периодически отправляйте запрос [Статус платежа](#invoice_get), чтобы получить информацию о платеже.
...
* Получите `paymentId` платежа:
     * Из [серверного уведомления](#payment_callback). Вы получите его после успешного холдирования средств.
