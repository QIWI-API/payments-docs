...
payment.<br>paymentSplits.<br>siteUid | ID поставщика | String|Для [сплитованных платежей](#payments_split)
...
----|------|-------|-------
token.<br>bankMemberId|Идентификатор банка покупателя|String|В случае успешной операции
----|------|-------|-------
