...
## Оплата СБП в тестовом режиме {#test_data_sbp}
...
## Выплаты в тестовом режиме {#payout-test-mode}

Для тестирования различных вариантов [выплаты](#safe-deal) и ответов указывайте разные суммы платежа (поле `amount.value`):
