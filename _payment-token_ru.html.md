...
Чтобы выпустить платежный токен карты, укажите в запросе API [Платеж](#payments) или [Создание счета](#invoice_put) (в зависимости от того, каким способом вы пользуетесь) дополнительные параметры:
