...
chequeType|string|**Обязательный параметр**. Признак расчета (тэг 1054):<br> `COLLECT` – Приход <br> `COLLECT_RETURN` - Возврат прихода <br> CONSUME - Расход <br> `CONSUME_RETURN` -Возврат расхода
