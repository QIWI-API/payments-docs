...
Чтобы отправить платеж со сплитованием, передайте в запросе API [Создание счета](#invoice_put) массив `splits` c данными поставщиков.

### Описание данных {#splits-qiwi-form}
...
### Описание данных {#payment-splits-merchant}
...
* В тело [уведомления](#refund-callback) с типом `REFUND` добавляется JSON-массив `refundSplits`, используемый для передачи информации о возвратах поставщикам. Формат массива см. [выше](#split-refund).
